        ...
        <div className="variantSection">
          ...
          <div className="gridding">
            <a href="/Recipe#PempekAdaan">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/adaan.jpg")} />
                </div>
                <p>Pempek Adaan</p>
              </div>
            </a>
            <a href="/Recipe#PempekLenjer">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/lenjer.jpg")} alt="" />
                </div>
                <p>Pempek Lenjer</p>
              </div>
            </a>
            <a href="/Recipe#PempekKeriting">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/keriting.jpg")} alt="" />
                </div>
                <p>Pempek Keriting</p>
              </div>
            </a>
            <a href="/Recipe#PempekTelur">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/telur.jpg")} alt="" />
                </div>
                <p>Pempek Telur</p>
              </div>
            </a>
            <a href="/Recipe#PempekPistel">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/pistel.jpg")} alt="" />
                </div>
                <p>Pempek Pistel</p>
              </div>
            </a>
            <a href="/Recipe#PempekPanggang">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/panggang.jpg")} alt="" />
                </div>
                <p>Pempek Panggang</p>
              </div>
            </a>
            <a href="/Recipe#PempekKulit">
              <div className="gridItem">
                <div className="gridBox">
                  <img src={require("./IMG/Pempek/kulit.jpeg")} alt="" />
                </div>
                <p>Pempek Kulit</p>
              </div>
            </a>
